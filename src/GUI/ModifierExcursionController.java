   ...
   private ComboBox<String> txtType;
    ...
    private void modifier(ActionEvent event) {
        ...
        try {
            ...
            ES.update(new Excurtion(txtDepart.getText(), txtDestination.getText(), val, txtCapacite.getText(), txtNom.getText(), txtHeure.getValue().toString(), txtDescription.getText() , txtDate.getValue().toString(), txtImg.getText(), txtType.getValue()));
